...
public class Evelynn extends Champion {
    ...
    public Evelynn(String name, String chamClass, String tribe, int tier, int hp, int mp, int power, double attackSpeed, int armor, int gold, int grade) {
    ...
    public void useSkill(AllUnit[] target) {
        if (getMp() >= getMAX_MP()) {
            ...
            System.out.println("/ MP " + getMp() + " ]");
            System.out.println("[Skill] 최후의 포옹 "); //150, 275, 400
            System.out.println("↓↓↓↓↓↓↓↓↓↓↓↓");
        }
    }
