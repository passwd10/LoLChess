...
public class Ahri extends Champion {
    ...
    public Ahri(String name, String chamClass, String tribe, int tier, int hp, int mp, int power, double attackSpeed, int armor, int gold, int grade) {
    ...
    public int useSkill(AllUnit[] target) {
        if (getMp() >= getMAX_MP()) {
            ...
            System.out.println("/ MP " + getMp() + " ]");
            System.out.println("[Skill] 현혹의 구슬 "); //150, 275, 400
            System.out.println("↓↓↓↓↓↓↓↓↓↓↓↓");
        }
        return 1;
    }
