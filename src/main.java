...
public class main {
    public static void main(String[] args) {
        ...
        while (gameRound < 20) {
            ...
            if(gameRound == 1) {
                round.startStage(gameRound, myDeck, myGold, botChampions[0], botChampions[1], botChampions[2]); //내덱,내돈, 3라운드, 챔피언3개
            } else if (gameRound == 2) {
                round.startStage(gameRound, myDeck, myGold, botChampions[2], botChampions[3], botChampions[4]); //내덱,내돈, 3라운드, 챔피언3개
            } else if(gameRound == 3) {
                round.startStage(gameRound, myDeck, myGold, botChampions[4], botChampions[5], botChampions[6]); //내덱,내돈, 3라운드, 챔피언3개
            } else if(gameRound == 4) {
                round.startStage(gameRound, myDeck, myGold, botChampions[6], botChampions[7], botChampions[8]); //내덱,내돈, 3라운드, 챔피언3개
            }
        }
    }
}
