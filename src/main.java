...
public class main {
    ...
    public static void main(String[] args) {
        ...
        champions[1] = new Khazix("카직스", "암살자", "공허", 1, 500, 50, 50, 0.6, 20, 1, 1);
        champions[2] = new Darius("다리우스", "기사", "제국", 1, 600, 100, 50, 0.5, 25, 1, 1);
        champions[3] = new Garen("가렌", "기사", "귀족", 1, 600, 100, 55, 0.55, 35, 1, 1);
        champions[4] = new Modaekaiser("모데카이저", "기사", "유령", 1, 550, 100, 50, 0.5, 35, 1, 1);
        champions[5] = new Warwick("워윅", "싸움꾼", "야생", 1, 600, 150, 50, 0.6, 30, 1, 1);
        ...
        champions[13] = new Lexai("렉사이", "싸움꾼", "공허", 2, 650, 150, 40, 0.65, 20, 2, 1);
        champions[14] = new Zed("제드", "암살자", "닌자", 2, 500, 75, 60, 0.65, 25, 2, 1);
        ...
        champions[24] = new Bbobbi("뽀삐", "기사", "요들", 3, 800, 75, 50, 0.5, 40, 3, 1);
        champions[25] = new Bolibear("볼리베어", "싸움꾼", "빙하", 3, 700, 75, 75, 0.55, 30, 3, 1);
        champions[26] = new Katarina("카타리나", "암살자", "제국", 3, 450, 100, 50, 0.65, 20, 3, 1);
        ...
        champions[35] = new Akali("아칼리", "암살자", "닌자", 4, 640, 25, 70, 2, 20, 4, 1);
        champions[36] = new Chogas("초가스", "싸움꾼", "공허", 4, 1000, 150, 70, 0.55, 20, 4, 1);
